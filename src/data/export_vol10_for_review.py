...
def export_vol10():
    ...
    report_lines = []
    report_lines.append("# Volume 10 Content Review")
    report_lines.append(f"**Goal:** Audit for Tone, Relevance, and Content Accuracy.")
    report_lines.append("")
    ...
    output_path = os.path.join(base_path, 'src/data/vol10_content_review.md')
