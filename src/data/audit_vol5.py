...
def audit_vol5():
    ...
    report_lines = []
    report_lines.append("# Audit Report: Volume 5 Content")
    ...
    for part in vol5['parts']:
        ...
        for topic in part['topics']:
            ...
            # Check All Levels
            for level_name, questions in topic['levels'].items():
    ...
    output_path = os.path.join(base_path, 'src/data/audit_report_vol5.md')
